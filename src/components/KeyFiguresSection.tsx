...
export const KeyFiguresSection: React.FC = () => {
  ...
  return (
    <section className="bg-[#084274] text-[#feeddb] py-12 sm:py-16 relative overflow-hidden border-y border-[#feeddb]/15">
      {/* Subtle modern particle highlights */}
      <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#feeddb_1px,transparent_1px)] [background-size:24px_24px] pointer-events-none" />
          ...
          {figures.map((fig, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white/5 hover:bg-white/10 border border-[#feeddb]/15 p-5 sm:p-6 flex flex-col items-center text-center group transition-all duration-300"
              >
                <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-white/10 flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 group-hover:bg-[#e3a044] transition-all duration-300 text-[#feeddb] group-hover:text-[#084274]">

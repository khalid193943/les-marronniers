...
const fieldCls =
  'w-full bg-[#0086d9]/6 border border-[#0086d9]/15 px-4 py-3 font-body text-[15px] text-[#0086d9] placeholder:text-[#00558d]/40 focus:outline-none focus:border-[#0086d9]/40 focus:bg-[#0086d9]/10 transition-colors';
...
const SuccessCard: React.FC<{ message: string }> = ({ message }) => (
  ...
  >
    ...
    />
    <div className="relative z-10 bg-[#0086d9] p-8 text-center shadow-xl">
      ...
      <p className="font-body text-sm text-[#fff7ef]/85">{message}</p>
...
const ErrorNote: React.FC = () => (
  ...
  >
    <p className="font-body text-sm text-[#0086d9] mb-3">

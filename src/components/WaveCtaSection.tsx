        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
            <button
              ...
              className="w-full sm:w-auto bg-white hover:bg-[#fff7ef] text-[#0086d9] font-bold text-base px-9 py-4.5 shadow-2xl transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer flex items-center justify-center gap-3 border-2 border-white group"
            >
              <Calendar className="w-5 h-5 text-[#ffe08a]" />
          ...
          <p className="text-xs text-white/90 mt-6 font-body">
            Lun – Ven · 7h45 – 18h15
          </p>
        </motion.div>
      </section>

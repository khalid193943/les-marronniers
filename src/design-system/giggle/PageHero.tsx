...
export const PageHero: React.FC<PageHeroProps> = ({ tag, title, line }) => (
  <header className="bg-[#feeddb] pt-14 pb-16 sm:pt-20 sm:pb-20 relative overflow-hidden">
    ...
    <DoodleSpiral className="hidden lg:block absolute top-16 right-[22%] w-8 text-[#084274]/25 pointer-events-none" />
